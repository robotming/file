                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="#" class="task-thumb">
                                <img src="{{asset('/template/img/avatar1.jpg')}}" alt="">
                            </a>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="{{asset('/template/img/sm-img-1.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{asset('/template/img/sm-img-2.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{asset('/template/img/sm-img-3.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{asset('/template/img/sm-img-1.jpg')}}">
                                                    </a>
                    ...
                    <section class="panel post-wrap pro-box">
                        ...
                        <aside class="post-highlight yellow v-align">
                            <div class="panel-body text-center">
                                <div class="pro-thumb">
                                    <img src="{{asset('/template/img/ring.jpg')}}" alt="">
                                </div>
                            </div>
                        </aside>
                    </section>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="{{asset('/template/img/follower-avatar.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
...
<script class="include" type="text/javascript" src="{{asset('/template/js/jquery.dcjqaccordion.2.7.js')}}"></script>
...
<script src="{{asset('/template/js/common-scripts.js')}}"></script>
